...
if((isset($_POST['email']) && !empty(trim($_POST['email']))) && (isset($_POST['mensagem']) && !empty(trim($_POST['mensagem'])))) {
	...
	$mail->SMTPAuth = true;
	$mail->Username = 'alex.consultoria.asi@gmail.com';
	$mail->Password = 'Alexsander123@';
	$mail->Port = 465;
 
	$mail->setFrom('alex.consultoria.asi@gmail.com');
	$mail->addAddress('alex.consultoria.asi@gmail.com');
